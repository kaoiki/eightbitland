<template>
  <div class="flex min-h-screen items-center justify-center px-4">
    <div class="w-full max-w-md border border-[rgba(66,73,78,0.2)] bg-[var(--color-surface-container)] p-8">
      ...
      <!-- 202604161844 将原来的@submit.prevent="goHome" 改为 @submit.prevent="register"-->
...
const toast = useToast() // 202604161145 调用useToast

// ↓ 202604081408  template中更新的dom所绑定的数据变量
const email = ref('')
...
async function getCode() {
  ...
  try {
    ...
    const res = await request.post('register-send-code',param)
    console.log(res)
    toast.add({
